 ...
 */
var flattenObject = function (obj, prefix, result, keys_limit, size_limit) {
...
var initializeLogs = function (posthog) {
    ...
    var _loop_1 = function (level) {
        var errorReplacer = function (_, value) {
        ...
        var logWrapper = function (originalConsoleLog) {
            return function () {
                ...
                if (args.length > 0) {
                    var body = args.map(function (a) { return JSON.stringify(a, errorReplacer); }).join(' ');
