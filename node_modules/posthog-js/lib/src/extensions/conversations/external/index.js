...
var ConversationsManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var _a;
                        var distinctId = _this._posthog.get_distinct_id();
                        var personProperties = ((_a = _this._posthog.persistence) === null || _a === void 0 ? void 0 : _a.props) || {};
                        // Priority for traits:
                        // 1. User-provided traits from the widget form
                        // 2. PostHog person properties
                        var name = (userTraits === null || userTraits === void 0 ? void 0 : userTraits.name) || personProperties.$name || personProperties.name || null;
                        var email = (userTraits === null || userTraits === void 0 ? void 0 : userTraits.email) || personProperties.$email || personProperties.email || null;
                        var payload = {
    ...
    ConversationsManager.prototype._getInitialUserTraits = function () {
        ...
        var personProperties = ((_a = this._posthog.persistence) === null || _a === void 0 ? void 0 : _a.props) || {};
        var posthogName = personProperties.$name || personProperties.name;
        var posthogEmail = personProperties.$email || personProperties.email;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.markAsRead(this._currentTicketId || undefined)];
                    case 2:
                        response = _b.sent();
    ...
    ConversationsManager.prototype._loadMessages = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, lastMessage, error_3;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.getMessages(this._currentTicketId || undefined, this._lastMessageTimestamp || undefined)
    ...
    ConversationsManager.prototype._setupIdentifyListener = function () {
        ...
        this._unsubscribeIdentifyListener = this._posthog.on('eventCaptured', function (event) {
            ...
            if (event.event === '$identify') {
                var newDistinctId = (_a = event.properties) === null || _a === void 0 ? void 0 : _a.distinct_id;
                var oldDistinctId = (_b = event.properties) === null || _b === void 0 ? void 0 : _b.$anon_distinct_id;
                if (oldDistinctId && newDistinctId && oldDistinctId !== newDistinctId) {
                    logger.info('Detected identify event', { oldDistinctId: oldDistinctId, newDistinctId: newDistinctId });
                    _this._handleDistinctIdChange(oldDistinctId, newDistinctId);
                }
            }
        });
    };
     ...
     */
    ConversationsManager.prototype._handleDistinctIdChange = function (oldDistinctId, newDistinctId) {
    ...
    ConversationsManager.prototype._renderWidget = function (initialState, initialUserTraits) {
        ...
        (0, preact_1.render)((0, jsx_runtime_1.jsx)(ConversationsWidget_1.ConversationsWidget, { ref: function (ref) {
            ...
            }, config: this._config, initialState: initialState, initialUserTraits: initialUserTraits, onSendMessage: this._handleSendMessage, onStateChange: this._handleStateChange, onIdentify: this._handleIdentify }), container);
    };
