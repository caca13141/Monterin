    ...
    var restorePatch = (0, patch_1.patch)(win, 'fetch', function (originalFetch) {
        return function (url, init) {
            return __awaiter(this, void 0, void 0, function () {
                var requestInit, hasDuplex, hasStreamBody, req, res, networkRequest, start, end, requestHeaders_1, _a, responseHeaders_1, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            requestInit = init ? __assign({}, init) : {};
                            hasDuplex = !(0, core_1.isUndefined)(init === null || init === void 0 ? void 0 : init.duplex);
                            hasStreamBody = (init === null || init === void 0 ? void 0 : init.body) instanceof ReadableStream || (url instanceof Request && url.body instanceof ReadableStream);
