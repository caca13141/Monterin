...
function TourButton(_a) {
    ...
    if (button.action === 'link' && button.link) {
        return ((0, jsx_runtime_1.jsx)("a", { href: button.link, target: "_blank", rel: "noopener noreferrer", class: className, children: button.text }));
    }
...
function ProductTourTooltipInner(_a) {
    ...
    var showDefaultButtons = !step.buttons && (step.progressionTrigger === 'button' || step.type === 'modal');
