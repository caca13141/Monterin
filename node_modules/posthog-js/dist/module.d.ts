...
import { Properties, PostHog as PostHog$1, PostHogConfig as PostHogConfig$1, PerformanceCaptureConfig, SessionRecordingCanvasOptions, InitiatorType, CapturedNetworkRequest, SessionRecordingOptions, ToolbarParams, JsonType, FeatureFlagDetail, EventName, RageclickConfig, SessionIdChangedCallback, DeadClicksAutoCaptureConfig, SeverityLevel, SupportedWebVitalsMetrics, CaptureResult, FeatureFlagsCallback, RemoteConfigFeatureFlagCallback, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, SurveyRenderReason, RequestResponse, RequestQueueConfig, RequestCallback, CaptureOptions, Property, ExceptionAutoCaptureConfig } from '@posthog/types';
export { AutocaptureCompatibleElement, AutocaptureConfig, BeforeSendFn, BootstrapConfig, CaptureOptions, CaptureResult, CapturedNetworkRequest, ConfigDefaults, DeadClickCandidate, DeadClicksAutoCaptureConfig, DomAutocaptureEvents, EarlyAccessFeature, EarlyAccessFeatureCallback, EarlyAccessFeatureResponse, EarlyAccessFeatureStage, ErrorTrackingOptions, EvaluationReason, EventName, ExceptionAutoCaptureConfig, ExternalIntegrationKind, FeatureFlagDetail, FeatureFlagMetadata, FeatureFlagsCallback, Headers, HeatmapConfig, InitiatorType, JsonRecord, JsonType, KnownEventName, MaskInputOptions, NetworkRequest, PerformanceCaptureConfig, Properties, Property, RageclickConfig, RemoteConfigFeatureFlagCallback, RequestCallback, RequestQueueConfig, RequestResponse, SessionIdChangedCallback, SessionRecordingCanvasOptions, SessionRecordingOptions, SeverityLevel, SlimDOMOptions, SupportedWebVitalsMetrics, SurveyRenderReason, ToolbarParams, ToolbarSource, ToolbarUserIntent, ToolbarVersion } from '@posthog/types';
import { SurveyAppearance as SurveyAppearance$1, ErrorTracking, SurveyPosition as SurveyPosition$1, Logger } from '@posthog/core';
export { KnownUnsafeEditableEvent } from '@posthog/core';
...
interface RequestWithOptions {
    ...
    callback?: (response: _posthog_types.RequestResponse) => void;
    timeout?: number;
    noRetries?: boolean;
...
type ProductTourDismissReason = 'user_clicked_skip' | 'user_clicked_outside' | 'escape_key' | 'element_unavailable';
...
export type { ActionStepStringMatching, ActionStepType, BasicSurveyQuestion, Breaker, ConversationsRemoteConfig, ConversationsTraits, ConversationsWidgetState, DisplaySurveyOptions, ErrorEventArgs, ErrorTrackingSuppressionRule, ErrorTrackingSuppressionRuleValue, EventHandler, FlagVariant, FlagsResponse, GetMessagesResponse, GetTicketsOptions, GetTicketsResponse, JSONContent, LinkSurveyQuestion, MarkAsReadResponse, Message, MessageAuthorType, MultipleSurveyQuestion, NetworkRecordOptions, OverrideConfig, PersistentStore, PostHogConfig, PostHogInterface, ProductTour, ProductTourAppearance, ProductTourBannerConfig, ProductTourButtonAction, ProductTourCallback, ProductTourConditions, ProductTourDismissReason, ProductTourRenderReason, ProductTourSelectorError, ProductTourStep, ProductTourStepButton, ProductTourStepButtons, ProductTourStepType, ProductTourSurveyQuestion, ProductTourSurveyQuestionType, PropertyFilters, PropertyMatchType, PropertyOperator, QueuedRequestWithOptions, RatingSurveyQuestion, RemoteConfig, RequestWithOptions, RetriableRequestWithOptions, SendMessageResponse, SessionRecordingPersistedConfig, SessionRecordingRemoteConfig, SessionRecordingUrlTrigger, SessionStartReason, ShowTourOptions, SiteApp, SiteAppGlobals, SiteAppLoader, SnippetArrayItem, Survey, SurveyActionType, SurveyAppearance, SurveyCallback, SurveyConfig, SurveyElement, SurveyEventWithFilters, SurveyQuestion, SurveyQuestionDescriptionContentType, SurveyWithTypeAndAppearance, Ticket, TicketStatus, UserProvidedTraits };
