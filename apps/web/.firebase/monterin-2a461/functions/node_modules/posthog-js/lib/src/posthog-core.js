...
var posthog_conversations_1 = require("./extensions/conversations/posthog-conversations");
...
var PostHog = /** @class */ (function () {
    function PostHog() {
        ...
        this.conversations = new posthog_conversations_1.PostHogConversations(this);
        this.logs = new posthog_logs_1.PostHogLogs(this);
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        if (this._hasBootstrappedFeatureFlags()) {
            var activeFlags_1 = Object.keys(((_d = config.bootstrap) === null || _d === void 0 ? void 0 : _d.featureFlags) || {})
                ...
                var _a, _b;
                res[key] = ((_b = (_a = config.bootstrap) === null || _a === void 0 ? void 0 : _a.featureFlags) === null || _b === void 0 ? void 0 : _b[key]) || false;
                return res;
            }, {});
    ...
    PostHog.prototype._initExtensions = function (startInCookielessMode) {
        ...
        initTasks.push(function () {
            _this.logs.loadIfEnabled();
        });
        initTasks.push(function () {
            _this.conversations.loadIfEnabled();
        });
        initTasks.push(function () {
            _this.productTours = new posthog_product_tours_1.PostHogProductTours(_this);
            _this.productTours.loadIfEnabled();
        });
        initTasks.push(function () {
        ...
        initTasks.push(function () {
            ...
            _this.exceptionObserver.startIfEnabledOrStop();
        });
        initTasks.push(function () {
    ...
    PostHog.prototype._onRemoteConfig = function (config) {
        ...
        (_f = this.productTours) === null || _f === void 0 ? void 0 : _f.onRemoteConfig(config);
        (_g = this.webVitalsAutocapture) === null || _g === void 0 ? void 0 : _g.onRemoteConfig(config);
        (_h = this.exceptionObserver) === null || _h === void 0 ? void 0 : _h.onRemoteConfig(config);
        this.exceptions.onRemoteConfig(config);
        (_j = this.deadClicksAutocapture) === null || _j === void 0 ? void 0 : _j.onRemoteConfig(config);
    };
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        // $identify calls.
        var markSetOnceAsSent = event_name !== '$groupidentify';
        var setOnceProperties = this._calculate_set_once_properties(options === null || options === void 0 ? void 0 : options.$set_once, markSetOnceAsSent);
        ...
        var requestOptions = {
            method: 'POST',
            url: (_c = options === null || options === void 0 ? void 0 : options._url) !== null && _c !== void 0 ? _c : this.requestRouter.endpointFor('api', this.analyticsDefaultEndpoint),
            data: data,
     ...
     */
    PostHog.prototype._calculate_set_once_properties = function (dataSetOnce, markAsSent) {
        var _a;
    ...
    PostHog.prototype.set_config = function (config) {
        ...
        if ((0, core_1.isObject)(config)) {
            ...
            (_g = this.externalIntegrations) === null || _g === void 0 ? void 0 : _g.startIfEnabledOrStop();
        }
    };
    /**
